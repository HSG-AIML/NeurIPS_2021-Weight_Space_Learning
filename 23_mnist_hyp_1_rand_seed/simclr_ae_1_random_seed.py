...
def main():
    ...
    experiment_name = "mnist_hyp_1_rand_seed"
    ...
    config["dataset::dump"] = Path('./../datasets/','dataset_23_mnist_hyp_1_rand_seed.pt').absolute()
    # make experiment dir
